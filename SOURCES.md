...
| 種別 | リンク | メモ |
|---|---|---|
| 経済的自由をつくる宿題リスト | https://libecity.com/mypage/fiveforces | 稼ぐ力タブに Claude Code / Cowork の宿題あり |
| 学習コンテンツ | https://libecity.com/room_list?room_id=President-Tweet&comment_id=UCoH8X43CxHNbGKTjNhO | 今、話題のエージェント型AI「Claude Code & CoWork」を使う方法 |
| 参考リンク | https://libecity.com/room_list?room_id=President-Tweet&comment_id=0eUma3DJwxNpKvv1as0w | Claude Code / Cowork の始め方とおすすめ初期設定 |
| 相談先 | https://libecity.com/room_list?room_id=GHpVBIsVIHdB2seJlnj8 | Claude部 |

## ノウハウ図書館

| 記事 | リンク | 虎の巻での使い方 |
|---|---|---|
| 初心者の味方、AIエージェント Claude Coworkで作業を任せる方法 | https://library.libecity.com/articles/01KM04CT0G46HVKKCHSWEA7Y4N | Cowork入口、本編や別冊5の学習導線 |
| これだけは設定しておいて！Claude Cowork / Code設定ガイド | https://library.libecity.com/articles/01KMSCAGSJKF97C2SWV81X0NTZ | 初期設定の参考リンク |
| Claude Code、Coworkのインストール手順解説 | https://library.libecity.com/articles/01KMPCB30RPW14V0WYA2BW5ARG | インストール手順の参考リンク |
...
| メモ | 位置づけ |
|---|---|
| `コンテキスト/学び/リベシティ宿題リスト/2026-05-07_稼ぐ力_Claude Code_Cowork宿題.md` | 宿題リストから取得した内容の保存メモ |
| `コンテキスト/学び/リベシティ宿題リスト/リベシティ宿題リストハブ.md` | 宿題リスト系の入口 |
| `コンテキスト/学び/ノウハウ図書館/ノウハウ図書館ハブ.md` | ノウハウ図書館の保存記事入口 |
| `はるかCEO/PJ_Claude Code初心者虎の巻/README.md` | 虎の巻PJの森側ハブ |
| `はるかCEO/PJ_Claude Code初心者虎の巻/進捗管理.md` | 共同編集と進捗の記録 |

## 追記ルール

- 会員向けリンクは、記事タイトル、URL、虎の巻での使い方をセットで残す
- 公開ページへ使う場合は、全文転載せず短い要約とリンクにする
- 料金、仕様、提供状況は変わる可能性があるので、必要に応じて公式リンクを確認する
